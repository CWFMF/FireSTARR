...
Perimeter::Perimeter(const HashSize hash_value,
                     const size_t size,
...
//   return burned_map_;
// }
[[nodiscard]] const list<HashSize>& Perimeter::burned() const noexcept
{
  return burned_;
}
[[nodiscard]] const list<HashSize>& Perimeter::edge() const noexcept
{
  return edge_;
}
}
